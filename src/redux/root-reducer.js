...
const persistConfig = {
  ...
  storage,
  whitelist: ['cart', 'directory'] // whitelist là 1 mảng chứa các tên của reducer mà mình muốn store. Ko cần user vì user được xử lý bởi firebase authentication rồi (Có observer lắng nghe r)
};
